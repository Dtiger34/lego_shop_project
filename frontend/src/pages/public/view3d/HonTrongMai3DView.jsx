...
const HonTrongMai3DView = () => {
  const { containerRef, isLoading, error } = use3DViewer("/hon_trong_mai-compressed.glb");
    ...
    <section className="view3d-section">
      <div className="view3d-container">
        <div className="view3d-header">
          ...
          <h2 className="section-title">Hòn Trong Mái - Hòn Đảo Linh Thiêng</h2>
        </div>

        <div className="view3d-content">
          <div className="view3d-text">
            <div className="intro-block">
              <h3 className="intro-title">Về Hòn Trong Mái</h3>
              <p className="intro-paragraph">
                Hòn Trong Mái là một hòn đảo nhỏ nằm giữa Hồ Gươm, nơi có một
                ngôi đền cổ với kiến trúc độc đáo. Hòn đảo này mang tên "Trong
                Mái" mang ý nghĩa là "trong nhà mái", biểu trưng cho sự yên bình
                và linh thiêng. Nơi đây là điểm dừng chân lý tưởng cho những ai
                muốn tìm kiếm sự yên tĩnh giữa lòng thành phố.
              </p>
            </div>
            ...
            <div className="intro-block">
              ...
              <p className="intro-paragraph">
                Hòn Trong Mái được ghi nhận với kiến trúc đền đạo truyền thống
                của Việt Nam. Ngôi đền trên hòn đảo này có mái theo phong cách
                cổ, với chi tiết trang trí tinh tế và các yếu tố phong thủy được
                bố trí hài hòa. Toàn bộ công trình phản ánh sự kết hợp hoàn hảo
            ...
            <div className="intro-block">
              ...
              <p className="intro-paragraph">
                Hòn Trong Mái là nơi thờ phụng linh thiêng của người dân Hà Nội,
                nơi họ đến để tìm kiếm bình an và lời cầu nguyện. Hàng năm, các
                lễ hội được tổ chức tại đây, thu hút hàng ngàn du khách và tín
                đồ. Hòn đảo này là một biểu tượng của đức tin và sự kính phục
                đối với tổ tiên của người Hà Nội.
              </p>
            </div>
          </div>
